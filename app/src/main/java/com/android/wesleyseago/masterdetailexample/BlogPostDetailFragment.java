package com.android.wesleyseago.masterdetailexample;
...
import com.android.wesleyseago.masterdetailexample.dummy.DummyContent;
...
public class BlogPostDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.blogpost_detail)).setText(mItem.description);
        }
